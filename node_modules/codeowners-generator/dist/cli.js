...
var require_color_name = __commonJS({
  "node_modules/ora/node_modules/color-name/index.js"(exports, module2) {
    "use strict";
    module2.exports = {
...
var require_conversions = __commonJS({
  "node_modules/ora/node_modules/color-convert/conversions.js"(exports, module2) {
...
var require_route = __commonJS({
  "node_modules/ora/node_modules/color-convert/route.js"(exports, module2) {
...
var require_color_convert = __commonJS({
  "node_modules/ora/node_modules/color-convert/index.js"(exports, module2) {
    var conversions = require_conversions();
...
var require_ansi_styles = __commonJS({
  "node_modules/ora/node_modules/ansi-styles/index.js"(exports, module2) {
    "use strict";
...
// node_modules/ora/node_modules/has-flag/index.js
var require_has_flag = __commonJS({
  "node_modules/ora/node_modules/has-flag/index.js"(exports, module2) {
    "use strict";
...
var require_supports_color = __commonJS({
  "node_modules/ora/node_modules/supports-color/index.js"(exports, module2) {
    "use strict";
    var os = require("os");
    var tty = require("tty");
...
var require_restore_cursor = __commonJS({
  "node_modules/restore-cursor/index.js"(exports, module2) {
    "use strict";
...
var require_color_name2 = __commonJS({
  "node_modules/log-symbols/node_modules/color-name/index.js"(exports, module2) {
    "use strict";
    module2.exports = {
      "aliceblue": [240, 248, 255],
      "antiquewhite": [250, 235, 215],
...
var require_conversions2 = __commonJS({
  "node_modules/log-symbols/node_modules/color-convert/conversions.js"(exports, module2) {
...
var require_route2 = __commonJS({
  "node_modules/log-symbols/node_modules/color-convert/route.js"(exports, module2) {
...
var require_color_convert2 = __commonJS({
  "node_modules/log-symbols/node_modules/color-convert/index.js"(exports, module2) {
    var conversions = require_conversions2();
...
var require_ansi_styles2 = __commonJS({
  "node_modules/log-symbols/node_modules/ansi-styles/index.js"(exports, module2) {
    "use strict";
    var wrapAnsi16 = (fn, offset) => (...args) => {
      const code = fn(...args);
      return `\x1B[${code + offset}m`;
...
var require_has_flag2 = __commonJS({
  "node_modules/log-symbols/node_modules/has-flag/index.js"(exports, module2) {
    "use strict";
    module2.exports = (flag, argv = process.argv) => {
      const prefix = flag.startsWith("-") ? "" : flag.length === 1 ? "-" : "--";
      const position = argv.indexOf(prefix + flag);
...
var require_supports_color2 = __commonJS({
  "node_modules/log-symbols/node_modules/supports-color/index.js"(exports, module2) {
    "use strict";
    var os = require("os");
    var tty = require("tty");
...
var require_util2 = __commonJS({
  "node_modules/log-symbols/node_modules/chalk/source/util.js"(exports, module2) {
    "use strict";
    var stringReplaceAll = (string, substring, replacer) => {
      let index = string.indexOf(substring);
      if (index === -1) {
...
var require_templates2 = __commonJS({
  "node_modules/log-symbols/node_modules/chalk/source/templates.js"(exports, module2) {
    "use strict";
    var TEMPLATE_REGEX = /(?:\\(u(?:[a-f\d]{4}|\{[a-f\d]{1,6}\})|x[a-f\d]{2}|.))|(?:\{(~)?(\w+(?:\([^)]*\))?(?:\.\w+(?:\([^)]*\))?)*)(?:[ \t]|(?=\r?\n)))|(\})|((?:.|[\r\n\f])+?)/gi;
    var STYLE_REGEX = /(?:^|\.)(\w+)(?:\(([^)]*)\))?/g;
    var STRING_REGEX = /^(['"])((?:\\.|(?!\1)[^\\])*)\1$/;
...
var require_source2 = __commonJS({
  "node_modules/log-symbols/node_modules/chalk/source/index.js"(exports, module2) {
    "use strict";
...
var require_is_unicode_supported = __commonJS({
  "node_modules/is-unicode-supported/index.js"(exports, module2) {
    "use strict";
    module2.exports = () => {
      if (process.platform !== "win32") {
        return true;
...
var require_stream_writable = __commonJS({
  "node_modules/readable-stream/lib/_stream_writable.js"(exports, module2) {
    ...
    function onwriteError(stream, state, sync3, er, cb) {
      --state.pendingcb;
      if (sync3) {
        process.nextTick(cb, er);
    ...
    function onwrite(stream, er) {
      ...
      if (er)
        onwriteError(stream, state, sync3, er, cb);
      else {
...
var require_stream_readable = __commonJS({
  "node_modules/readable-stream/lib/_stream_readable.js"(exports, module2) {
    ...
    if (debugUtil && debugUtil.debuglog) {
      debug7 = debugUtil.debuglog("stream");
    } else {
      debug7 = function debug8() {
      };
    }
    ...
    Readable.prototype.read = function(n) {
      ...
      if (n === 0 && state.needReadable && ((state.highWaterMark !== 0 ? state.length >= state.highWaterMark : state.length > 0) || state.ended)) {
        debug7("read: emitReadable", state.length, state.ended);
      ...
      debug7("need readable", doRead);
      if (state.length === 0 || state.length - n < state.highWaterMark) {
        doRead = true;
        debug7("length less than watermark", doRead);
      }
      if (state.ended || state.reading) {
        doRead = false;
        debug7("reading or ended", doRead);
      } else if (doRead) {
        debug7("do read");
        state.reading = true;
        state.sync = true;
    ...
    function emitReadable(stream) {
      var state = stream._readableState;
      debug7("emitReadable", state.needReadable, state.emittedReadable);
      state.needReadable = false;
      if (!state.emittedReadable) {
        debug7("emitReadable", state.flowing);
        state.emittedReadable = true;
    ...
    function emitReadable_(stream) {
      var state = stream._readableState;
      debug7("emitReadable_", state.destroyed, state.length, state.ended);
    ...
    Readable.prototype.pipe = function(dest, pipeOpts) {
      ...
      state.pipesCount += 1;
      debug7("pipe count=%d opts=%j", state.pipesCount, pipeOpts);
      ...
      function ondata(chunk) {
        ...
        debug7("dest.write", ret);
        if (ret === false) {
          if ((state.pipesCount === 1 && state.pipes === dest || state.pipesCount > 1 && indexOf(state.pipes, dest) !== -1) && !cleanedUp) {
            debug7("false write response, pause", state.awaitDrain);
            state.awaitDrain++;
          }
          src.pause();
        }
    ...
    function pipeOnDrain(src) {
      return function pipeOnDrainFunctionResult() {
        ...
        debug7("pipeOnDrain", state.awaitDrain);
        if (state.awaitDrain)
          state.awaitDrain--;
    ...
    Readable.prototype.on = function(ev, fn) {
      ...
      if (ev === "data") {
        ...
        if (!state.endEmitted && !state.readableListening) {
          ...
          state.flowing = false;
          state.emittedReadable = false;
          debug7("on readable", state.length, state.reading);
          if (state.length) {
            emitReadable(this);
    ...
    function nReadingNextTick(self2) {
      debug7("readable nexttick read 0");
      self2.read(0);
    }
    ...
    Readable.prototype.pause = function() {
      debug7("call pause flowing=%j", this._readableState.flowing);
    ...
    function endReadable(stream) {
      var state = stream._readableState;
      debug7("endReadable", state.endEmitted);
      if (!state.endEmitted) {
        state.ended = true;
    ...
    function endReadableNT(state, stream) {
      debug7("endReadableNT", state.endEmitted, state.length);
...
var require_out = __commonJS({
  "node_modules/@nodelib/fs.stat/out/index.js"(exports) {
    ...
    function statSync(path3, optionsOrSettings) {
      ...
      return sync3.read(path3, settings);
    }
...
var require_stripIndents = __commonJS({
  "node_modules/common-tags/lib/stripIndents/stripIndents.js"(exports, module2) {
    ...
    var stripIndents3 = new _TemplateTag2.default((0, _stripIndentTransformer2.default)("all"), _trimResultTransformer2.default);
    exports.default = stripIndents3;
    module2.exports = exports["default"];
  }
});
...
var import_common_tags = __toESM(require_lib4());
var SUCCESS_SYMBOL = "\u{1F4AB}";
var SHRUG_SYMBOL = "\xAF\\_(\u30C4)_/\xAF";
var OUTPUT = "CODEOWNERS";
var INCLUDES = ["**/CODEOWNERS", "!CODEOWNERS", "!.github/CODEOWNERS", "!docs/CODEOWNERS", "!node_modules"];
var PACKAGE_JSON_PATTERN = ["**/package.json"];
var IGNORE_ROOT_PACKAGE_JSON_PATTERN = ["!package.json"];
var MAINTAINERS_EMAIL_PATTERN = /<(.+)>/;
var IGNORE_FILES_PATTERN = [".gitignore"];
var CHARACTER_RANGE_PATTERN = /\[(?:.-.)+\]/;
var LINE_ENDING_PATTERN = /\r?\n/;
var CONTENT_MARK = import_common_tags.stripIndents`
...
// src/utils/getCustomConfiguration.ts
var debug2 = logger("customConfiguration");
var getCustomConfiguration = async () => {
  const loader = (0, import_ora.default)("Loading configuration").start();
  try {
    const explorer = (0, import_cosmiconfig.cosmiconfig)(package_default.name);
    const result = await explorer.search();
    if ((result == null ? void 0 : result.config) && typeof result.config === "object") {
      loader.stopAndPersist({ text: `Custom configuration found in ${result.filepath}`, symbol: SUCCESS_SYMBOL });
      debug2("custom configuration found:", result);
...
var getOptionsFromCommand = (command2) => {
  const {
    parent: { includes }
  } = command2;
  return { includes: makeArray(includes) };
};
var getGlobalOptions = async (command2) => {
  var _a, _b;
  const options = getOptionsFromCommand(command2);
  const customConfiguration = await getCustomConfiguration();
  if (!((_a = options.includes) == null ? void 0 : _a.length) && customConfiguration && ((_b = customConfiguration.includes) == null ? void 0 : _b.length)) {
...
var debug3 = logger("readFile");
var readFile = (0, import_util.promisify)(import_fs.default.readFile);
var readContent = async (filePath) => {
  debug3("reading...", filePath);
...
var import_common_tags2 = __toESM(require_lib4());
var getContentLegend = (customRegenerationCommand) => import_common_tags2.stripIndents`
...
# ${customRegenerationCommand ? `To re-generate, run \`${customRegenerationCommand}\`. ` : ""}Don't worry, the content outside this block will be kept. 
`;
var generatedContentTemplate = (generatedContent, customRegenerationCommand) => {
  return import_common_tags2.stripIndents`
  ${CONTENT_MARK}
...
var rulesBlockTemplate = (source, entries) => {
  return import_common_tags2.stripIndents`
  # Rule${entries.length > 1 ? "s" : ""} extracted from ${source}${entries.some((rule) => rule.trim().includes(" ")) ? "" : " (containing path exclusions)"}
  ${entries.join("\n")}
  `;
};

// src/utils/codeowners.ts
var debug4 = logger("utils/codeowners");
var { dirname, join } = import_path.posix;
var isString = (x) => {
  return typeof x === "string";
};
var isObject = (x) => x !== null && typeof x === "object";
var filterGeneratedContent = (content) => {
...
var generateOwnersFile = async (outputFile, ownerRules, groupSourceComments = false, preserveBlockPosition = false, customRegenerationCommand) => {
  let originalContent = "";
  if (import_fs2.default.existsSync(outputFile)) {
    debug4(`output file ${outputFile} exists, extracting content before overwriting`);
    originalContent = await readContent(outputFile);
  }
  let content = [];
  if (groupSourceComments) {
    const groupedRules = (0, import_lodash.default)(ownerRules, (rule) => rule.filePath);
...
var parseCodeOwner = (filePath, codeOwnerContent) => {
...
var isValidCodeownersGlob = (glob) => {
  ...
  const doesNotUseCharacterRange = !(0, import_is_glob.default)(glob) || !CHARACTER_RANGE_PATTERN.test(glob);
  return isGlobString && isNotEmpty && isNotNegated && doesNotUseBraceExpansion && doesNotStartWithEscapedHash && doesNotUseCharacterRange;
};
var translateGlob = (glob) => {
  if (glob.startsWith("/")) {
    return glob;
  }
  ...
  if (!(0, import_is_glob.default)(glob) && glob.indexOf("/") === glob.length - 1) {
    return join("**", glob);
  }
  return glob;
};
var createMatcherCodeownersRule = (filePath, rule) => {
...
var loadCodeOwnerFiles = async (dirname3, files) => {
  const codeOwners = await Promise.all(
    files.map(async (filePath) => {
      const content = await readContent(filePath);
      return parseCodeOwner(filePath.replace(`${dirname3}/`, ""), content);
    })
  );
  return codeOwners.reduce((memo, rules) => [...memo, ...rules], []);
};
var getOwnersFromMaintainerField = (filePath, content) => {
  try {
...
var loadOwnersFromPackage = async (dirname3, files) => {
  const codeOwners = await Promise.all(
    files.map(async (filePath) => {
      const content = await readContent(filePath);
      try {
        return getOwnersFromMaintainerField(filePath.replace(`${dirname3}/`, ""), content);
      } catch (e) {
        return void 0;
      }
    })
...
var debug5 = logger("parseIgnoreFiles");
var getPatternsFromIgnoreFiles = async () => {
  const matches = (0, import_fast_glob.sync)(IGNORE_FILES_PATTERN, {
    onlyFiles: true,
    absolute: true
  });
  debug5("found", matches);
  const filesContent = await Promise.all(
    matches.map(async (filePath) => {
      try {
        ...
        debug5(`We failed when reading ${filePath}, skipping file. reason: `, e);
        return [];
      }
    })
  );
  const patterns = filesContent.reduce((memo, patterns2) => [...memo, ...patterns2], []);
  debug5("ignore patterns found:", patterns);
  return patterns;
};

// src/commands/generate.ts
var debug6 = logger("generate");
var { basename, dirname: dirname2 } = import_path2.posix;
var generate = async ({ rootDir, includes, useMaintainers = false, useRootMaintainers = false }) => {
  var _a, _b, _c;
  debug6("input:", rootDir, includes, useMaintainers, useRootMaintainers);
  const includePatterns = includes && includes.length ? includes : INCLUDES;
  debug6("includePatterns:", includePatterns);
  ...
  debug6("provided globs:", globs);
  const matches = (0, import_fast_glob2.sync)(globs, {
    onlyFiles: true
  });
  debug6("files found:", matches);
  const ig = (0, import_ignore.default)().add(await getPatternsFromIgnoreFiles());
  let files = matches.filter(ig.createFilter());
  debug6("matches after filtering ignore patterns:", files);
  let codeOwners = [];
  if (matches.length) {
    if (useMaintainers) {
      const groups = (0, import_lodash2.default)(files, (filePath) => basename(filePath) === "package.json" ? "json" : "txt");
      if ((_a = groups.json) == null ? void 0 : _a.length) {
        const codeownersDirNames = new Set((_b = groups.txt) == null ? void 0 : _b.map((path3) => dirname2(path3)));
        const filteredJSONs = groups.json.filter((packageJsonFile) => {
          if (codeownersDirNames.has(dirname2(packageJsonFile))) {
            console.warn(
...
var command = async (options, command2) => {
  var _a;
  const globalOptions = await getGlobalOptions(command2);
  const { check } = options;
  const output = options.output || globalOptions.output || OUTPUT;
  const loader = (0, import_ora2.default)("generating codeowners...").start();
  ...
  try {
    ...
    if (ownerRules.length) {
      ...
      if (check) {
        ...
        import_fs3.default.writeFileSync(output, newContent);
      }
      loader.stopAndPersist({ text: `CODEOWNERS file was created! location: ${output}`, symbol: SUCCESS_SYMBOL });
    } else {
      const includes = ((_a = globalOptions.includes) == null ? void 0 : _a.length) ? globalOptions.includes : INCLUDES;
    ...
    const error = e;
    debug6(`We encountered an error: ${error.message}`);
...
// src/bin/cli.ts
import_commander.default.name(package_default.name).version(package_default.version).description(package_default.description).option("--includes [glob patterns...]", `The patterns that match CODEOWNERS files, by default ${INCLUDES}`);
import_commander.default.command("generate").description("Generates a topLevel file containing the paths of all the nested CODEOWNERS").option(
  "--use-maintainers",
...
).option("--output [output file]", "The output path and name of the file, (default: CODEOWNERS)").option(
  "--check",
